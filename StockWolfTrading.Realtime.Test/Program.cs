...
namespace StockWolfTrading.Realtime.Test
{
    class Program
    {
        static void Main(string[] args)
        {
            //SocketIOClient client = new SocketIOClient(new SocketIOClientOption(EngineIOScheme.https, "stockwolftradingrealtimeapi.azurewebsites.net", 443));
            SocketIOClient client = new SocketIOClient(new SocketIOClientOption(EngineIOScheme.http, "h2825846.stratoserver.net", 9001));
